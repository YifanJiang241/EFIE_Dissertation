...
Et = complex(zeros(1, NoLinesubs)); % 初始化Et数组

for index = 1:stp:NoLinesubs
    Et(index) = complex(0.0, 0.0); % 初始化为复数0
    index
    for n = 1:stp:index %100m
        % 更新Et[index]值，注意MATLAB索引从1开始
